...
### 🔒 Sensitive Content Awareness (v2.7.0)
...
> **Note:** Pin a tagged release (e.g. `2.7.3`) rather than `branch: "main"` so clean checkouts and CI resolve a reproducible version. See [CHANGELOG.md](CHANGELOG.md) for what each release contains.
